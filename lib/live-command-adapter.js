 ...
 * Legacy commands remain the single owner of their existing names, avoiding
 * duplicate command definitions during the migration.
 */
function registerPhase1Commands(registry) {
  ...
  // tagall/hidetag already exist in index.js. Do not register second copies;
  // their dedicated mention service remains available to future migrations.
